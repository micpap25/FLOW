...
public class PlatformerPlayer : MonoBehaviour {
	...
	void Start () {
		...
		QCFInput = new List<string>{ "down", "downfront", "front" };
		QCBInput = new List<string>{ "down", "downback", "back" };
		DQCFInput = new List<string>{ "front", "down", "downfront" };
		DQCBInput = new List<string>{ "back", "down", "downback" };
	...
	void FixedUpdate () {
		...
		//TODO: CHANGE USING GROUNDCHECKER!
